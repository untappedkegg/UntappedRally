...
public class ImageDialogAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = inflater.inflate(com.untappedkegg.rally.R.layout.generic_image_dialog_image, container, false);
        ImageView imageView = (ImageView) view.findViewById(com.untappedkegg.rally.R.id.generic_image_dialog_image);
